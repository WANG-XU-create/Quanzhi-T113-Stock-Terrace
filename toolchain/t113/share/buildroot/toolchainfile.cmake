...
set(CMAKE_C_COMPILER "${RELOCATED_HOST_DIR}/bin/arm-linux-gnueabi-gcc")
set(CMAKE_CXX_COMPILER "${RELOCATED_HOST_DIR}/bin/arm-linux-gnueabi-g++")
if(1)
  ...
  set(CMAKE_Fortran_COMPILER "${RELOCATED_HOST_DIR}/bin/arm-linux-gnueabi-gfortran")
endif()
