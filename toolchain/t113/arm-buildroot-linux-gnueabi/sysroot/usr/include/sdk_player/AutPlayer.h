...
#include <libcedarx/cdx_config.h>
#include <libcedarx/cdx_log.h>
#include <libcedarx/xplayer.h>
#include <libcedarx/CdxTypes.h>
#include <libcedarx/mediaInfo.h>

#include <sdk_disp/hwdisp2.h>
...
{
public:
    AUTPlayer(SoundCtrl *sndCtrl = NULL, LayerCtrl *layerCtrl = NULL, SubCtrl *subCtrl = NULL);
    ...
    int  getCurBuffInfo(int *with, int *height, uint8_t **vir_y);
    int  getDispwidth();
    int  getDispheigth();
