...
#define PIXELS_6K       19000000 //* The lower limit of 6K pixel size is defined as 19000000, and the standard resolution may be 6144x3456
...
enum ECONTAINER
{
    ...
    CONTAINER_TYPE_CAF      = CDX_PARSER_CAF,
