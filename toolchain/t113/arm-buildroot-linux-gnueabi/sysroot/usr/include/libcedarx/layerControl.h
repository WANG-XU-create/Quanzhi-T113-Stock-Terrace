...
enum CdxLayerCommandE
{
    ...
    CDX_LAYER_CMD_GET_WHETHER_QUEUETOSF = 0x104,
    CDX_LAYER_CMD_SET_HOLD_BY_GPU_BUFFER_NUM = 0x105,
    CDX_LAYER_CMD_SET_VIDEO_RESOLUTION_CHANGED = 0x106,
#if TINA_LINUX_SUPPORT
    CDX_LAYER_CMD_SET_VIDEOCODEC_LBC_MODE = 0x107,
    CDX_LAYER_CMD_GET_SCREEN_WIDTH_HEIGHT = 0x108,
#endif
};

static inline void LayerRelease(LayerCtrl* l)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerSetSecureFlag(LayerCtrl* l, int f)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerSetDisplayBufferSize(LayerCtrl* l, int w, int h)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerSetDisplayBufferCount(LayerCtrl* l, int n)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerSetDisplayRegion(LayerCtrl* l, int left, int top,
                                    int w, int h)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerSetDisplayPixelFormat(LayerCtrl* l, enum EPIXELFORMAT p)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerSetVideoWithTwoStreamFlag(LayerCtrl* l, int f)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerSetIsSoftDecoderFlag(LayerCtrl* l, int flag)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerSetBufferTimeStamp(LayerCtrl* l, int64_t pts)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline void LayerResetNativeWindow(LayerCtrl* l,void* p)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline VideoPicture* LayerGetBufferOwnedByGpu(LayerCtrl* l)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerGetDisplayFPS(LayerCtrl* l)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerGetBufferNumHoldByGpu(LayerCtrl* l)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerCtrlShowVideo(LayerCtrl* l)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerCtrlHideVideo(LayerCtrl* l)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerCtrlIsVideoShow(LayerCtrl* l)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerCtrlHoldLastPicture(LayerCtrl* l, int h)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerDequeueBuffer(LayerCtrl* l, VideoPicture** p, int f)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerQueueBuffer(LayerCtrl* l, VideoPicture* p, int f)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerReleaseBuffer(LayerCtrl* l,VideoPicture* p)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerReset(LayerCtrl* l)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline void LayerDestroy(LayerCtrl* l)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
...
static inline int LayerControl(LayerCtrl* l, int cmd, void *para)
{
    CDX_CHECK(l);
    CDX_CHECK(l->ops);
