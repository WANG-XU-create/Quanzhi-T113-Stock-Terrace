...
#define AUDIO_BITSTREAM_BUFFER_SIZE (1024*4096)
#define AUDIO_BITSTREAM_BUFFER_MAX_FRAME_NUM (4096)
#define AUDIO_PCM_BUFFER_SIZE (512*1024)
...
enum EAUDIOCODECFORMAT
{
    ...
    AUDIO_CODEC_FORMAT_MPEG_AAC_LATM,
    AUDIO_CODEC_FORMAT_WV,
    AUDIO_CODEC_FORMAT_DRA,  //0x1f
