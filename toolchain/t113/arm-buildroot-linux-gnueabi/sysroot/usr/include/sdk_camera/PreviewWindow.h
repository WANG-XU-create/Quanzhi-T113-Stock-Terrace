...
#include <sdk_disp/aut_tr.h>
#include <sdk_disp/hwdisp2.h>
#include <sdk_camera/DiHandle.h>
...
#define DISP_NB_BUFFER 3

class V4L2CameraDevice;
#define PBUFFER_SIZE (1280*720*3/2)
...
***************************************************************************/ public:
    ...
    /*rotate clockwise : 0: no ratate 1: 90 2: 180 3: 270*/
    int rotate_mode;
