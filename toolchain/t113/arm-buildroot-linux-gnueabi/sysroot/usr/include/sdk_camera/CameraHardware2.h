...
#include <sdk_camera/videodev2_new.h>
#include <sdk_camera/CameraParameters.h>
#include <sdk_camera/hardware.h>
#include <sdk_camera/V4L2CameraDevice2.h>
#include <sdk_camera/PreviewWindow.h>
...
#define KEY_CANCEL_CONTINUOUS_PICTURE   "cancel_continuous_picture"
...
public:
    ...
    CameraHardware(int width, int height);
...
public:
     ...
     * Note that failures in this method are reported as negave EXXX statuses.
     */
    virtual status_t sendCommand(camera_cmd_t cmd, unsigned long arg1, int32_t arg2);
