...
#define SECTION_ROTATE_PREFIX "rotate"
...
#define CAMERA_KEY_ROTATE "rot_mode"

#define CAMERA_ENCODE_FORMAT  "encode_format"
#define CAMERA_V4L2_FORMAT  "v4l2_format"
...
int config_get_width(int section);
...
int config_get_encode_fmt(int section);
int config_get_v4l2_fmt(int section);
...
int config_set_width(int section, int width);
