...
#include <sdk_camera/hardware.h>

//#define ADAS
#define WATERMARK
#define START_STOP_RENDER
//__BEGIN_DECLS

//android\device\softwinner\t3-common\BoardConfigCommon.mk ADAS_ENABLE
//#define ADAS_ENABLE 1
...
enum {
    ...
    #ifdef ADAS_ENABLE
    CAMERA_MSG_ADAS_METADATA = 0x10000,
    #endif
    CAMERA_MSG_ALL_MSGS = 0xFFFFFF
};
...
typedef enum {
    ...
    #ifdef ADAS_ENABLE
    CAMERA_CMD_START_ADAS_DETECTION = 11,
    CAMERA_CMD_STOP_ADAS_DETECTION = 12,
    #endif

    #ifdef WATERMARK
    CAMERA_CMD_START_WATER_MARK = 13,
    CAMERA_CMD_STOP_WATER_MARK = 14,
    #endif
    #ifdef START_STOP_RENDER
    CAMERA_CMD_START_RENDER = 15,
    CAMERA_CMD_STOP_RENDER = 16,
    #endif

    CAMERA_CMD_SET_WHITE_BALANCE = 17,
    CAMERA_CMD_SET_COLOR_EFFECT = 18,
    CAMERA_CMD_SET_EXPOSURE_COMPENSATION = 19,

    CAMERA_CMD_SET_SCREEN_ID = 0xFF000000,
    CAMERA_CMD_SET_CEDARX_RECORDER = 0xFF000001,
    CAMERA_CMD_SET_GPSDATA_RECORDER = 0xFF000002,
} camera_cmd_t;
