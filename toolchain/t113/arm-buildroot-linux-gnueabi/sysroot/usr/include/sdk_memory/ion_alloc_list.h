...
static inline void aw_prefetchw(const void *x)
{
    (void)x;
}
 ...
 */
static inline void __aw_list_add(struct aw_mem_list_head *aw_new, struct aw_mem_list_head *aw_prev, struct aw_mem_list_head *aw_next)
{
    aw_next->aw_prev = aw_new;
    aw_new->aw_next = aw_next;
    aw_new->aw_prev = aw_prev;
    aw_prev->aw_next = aw_new;
}
 ...
 */
static inline void aw_mem_list_add(struct aw_mem_list_head *aw_new, struct aw_mem_list_head *head)
{
    __aw_list_add(aw_new, head, head->aw_next);
}
 ...
 */
static inline void aw_mem_list_add_tail(struct aw_mem_list_head *aw_new, struct aw_mem_list_head *head)
{
    __aw_list_add(aw_new, head->aw_prev, head);
}
