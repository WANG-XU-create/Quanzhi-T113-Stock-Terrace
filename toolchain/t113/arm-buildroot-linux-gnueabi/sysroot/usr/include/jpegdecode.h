...
typedef struct JpegDecoderContext
{
    ...
    int                          mOutputDataType;
    uint32_t mDecodedYuvCapacity;
    uint32_t mDecodedRgb565Capacity;
...
int JpegDecoderInitial(JpegDecoder* v);
int JpegDecoderReopen(JpegDecoder* v);
...
ImgFrame *JpegDecoderFrame(JpegDecoder* v);
